                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/product/findAll.do?page=1&size=4'"><i class="fa fa-refresh"></i> 刷新</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tbody>
                        <c:forEach items="${PageInfo.list}" var="productlist">
                            <tr>
                                <td><input name="subcheck" id="subcheck" type="checkbox" value="${productlist.id}"></td>
                                <td>${productlist.id}</td>
                                <td>${productlist.productNum}</td>
                                <td>${productlist.productName}</td>
                                <td>${productlist.cityName}</td>
                                <td>${productlist.departureTimeStr}</td>
                                <td class="text-center">${productlist.productPrice}</td>
                                <td class="text-center">${productlist.productDesc}</td>
                                <td class="text-center">${productlist.productStatusStr}</td>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                           ...
                           <c:forEach begin="1" end="${PageInfo.pages}" var="pageNum">
                            <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${PageInfo.pageNum}&size=${PageInfo.pageSize}">${pageNum}</a></li>
                           </c:forEach>
